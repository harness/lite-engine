...
func SetupRunTestV2(ctx context.Context, config *api.RunTestsV2Config, stepID, workspace string, uniqueStepId string, log *logrus.Logger, envs map[string]string, tiConfig *tiCfg.Cfg, testMetadata *types.TestIntelligenceMetaData) (string, error) {
