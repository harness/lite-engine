...
type bintreeT struct {
	Func     func() ([]byte, error)
	Children map[string]*bintreeT
}

var _bintree = &bintreeT{nil, map[string]*bintreeT{
	"visgraph.avsc": {visgraph_avsc, map[string]*bintreeT{}},
}}
