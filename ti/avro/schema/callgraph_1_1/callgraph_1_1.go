...
func callgraph_1_1Avsc() (*asset, error) {
	...
	info := bindataFileInfo{name: "callgraph_1_1.avsc", size: 2008, mode: os.FileMode(420), modTime: time.Unix(1753945584, 0)}
