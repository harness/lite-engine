...
func ComputeSelectedTestsV2(ctx context.Context, runConfigV2 *api.RunTestsV2Config, log *logrus.Logger,
	...
	log.Info("SplitIdx and SplitTotal values", splitIdx, splitTotal)
	...
	splitTests, err := getSplitTests(ctx, log, tests, stepID, countTestSplitStrategy, splitIdx, splitTotal, tiConfig)
	if err != nil {
